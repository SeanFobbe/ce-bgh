...
Im Datensatz sind ab 2023 auch Zitate zwischen einzelnen Verfahren des BGH enthalten. Aus den Vollexten der BGH-Entscheidungen wurden alle Aktenzeichen des BGH extrahiert und mit dem Aktenzeichen der zitierenden Entscheidung verbunden.

**Achtung:** Es handelt sich nicht um Zitate von Entscheidung zu Entscheidung, sondern von Aktenzeichen zu Aktenzeichen. Die Auflösung der Zitate auf Entscheidungsebene ist geplant und wird in Zukunft mitveröffentlicht.

Beachten Sie auch bitte folgende Punkte:

- Das gesamte Netzwerk ist sehr groß (ca. 85.000 Knoten, ca. 300.000 Kanten) und die Analyse ist daher ohne weitere Einschränkungen rechenintensiv und anspruchsvoll. In der Regel sollten Sie das Netzwerk auf die für Sie interessanten Teile reduzieren.
...
- Alle Knoten die nach der Extraktion kein gültiges Aktenzeichen des BGH enthalten wurden entfernt, das betrifft nur eine kleine zweistellige Zahl (siehe Compilation Report für den genauen Wert)




```{r, CE-BGH_15_Zitate_Graph_karmesinrot, fig.width = 28, fig.height = 16, fig.pos = "p", dpi = 150, dev = "png", fig.cap = "Das interne Zitationsnetzwerk (Aktenzeichen) des 11. Zivilsenats des Bundesgerichthofs (Kamada Kawai-Layout)"}
