...
```{r, CE-BGH_Zitate_Graph_schwarzweiss, fig.width = 28, fig.height = 16, fig.pos = "p", dpi = 150, dev = "png", fig.cap = "Das interne Zitationsnetzwerk (Aktenzeichen) des 11. Zivilsenats des Bundesgerichthofs (Sugiyama Layout)."}
