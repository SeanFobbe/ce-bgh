...
```{r, CE-BGH_15_Zitate_Graph_karmesinrot, fig.width = 12, fig.height = 14, fig.pos = "p", fig.cap = "Das interne Zitationsnetzwerk (Aktenzeichen) des 11. Senats des Bundesgerichthofs (Kamada Kawai-Layout)"}
...
ggraph(g, "kk") + 
    ...
    labs(
        title = paste(prefix.figuretitle,
                      "| Das interne Zitationsnetzwerk (Aktenzeichen) des 11. Senats des Bundesgerichthofs"),
        caption = caption
    )+
    theme(
        plot.title = element_text(size = 14,
