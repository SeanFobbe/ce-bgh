...
Dieser Datensatz ist eine digitale Zusammenstellung von möglichst allen Entscheidungen, die auf der amtlichen Internetpräsenz des Bundesverwaltungsgerichts (BGH) am jeweiligen Stichtag veröffentlicht waren. Die Stichtage für jede Version entsprechen exakt der Versionsnummer.
...
\midrule
 ...
 Primäre Datenquelle & \url{https://www.bgh.de}\\
...
4. Erst ab dem Jahr 2002 sind begründete Entscheidungen des BGH einigermaßen vollständig veröffentlicht (\emph{temporal bias}). Die Frequenztabellen geben hierzu genauer Auskunft.
...
\begin{verbatim}
 BGH_2004-08-12_U_5_C_58_03_NA_0.pdf
\end{verbatim}
