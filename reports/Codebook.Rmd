...
```{r, CE-BGH_Zitate_Graph_karmesinrot, fig.width = 28, fig.height = 16, fig.pos = "p", dpi = 150, dev = "png", fig.cap = "Das interne Zitationsnetzwerk (Aktenzeichen) des 11. Zivilsenats des Bundesgerichthofs (Sugiyama Layout)."}
...
ggraph(g, "sugiyama") + 
    ...
    labs(
        title = paste(prefix.figuretitle,
                      "| Das interne Zitationsnetzwerk (Aktenzeichen) des 11. Zivilsenats des Bundesgerichthofs"),
        caption = caption
    )+
    theme(
        plot.title = element_text(size = 14,
