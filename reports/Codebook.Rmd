...
```{r, CE-BGH_15_Zitate_Graph_karmesinrot, fig.width = 12, fig.height = 14, fig.pos = "p", fig.cap = "Das Zitationsnetzwerk (Aktenzeichen) des 1. Senats"}


index <- which(V(igraph.citations.cleaned)$senat == " I"

g <- subgraph(igraph.citations.cleaned, index)
...
ggraph(g,
    ...
    labs(
        title = paste(prefix.figuretitle,
                      "| Das Zitationsnetzwerk (Aktenzeichen) des 1. Senats"),
        caption = caption
    )+
    theme(
        plot.title = element_text(size = 14,
