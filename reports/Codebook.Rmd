...
```{r, CE-BGH_09_Density_Zeichen, fig.height = 6, fig.width = 9}
...
```{r,  CE-BGH_10_Density_Tokens, fig.height = 6, fig.width = 9}
ggplot(data = dt.bgh.meta)+
...
```{r, CE-BGH_11_Density_Typen, fig.height = 6, fig.width = 9}
ggplot(data = dt.bgh.meta)+
...
```{r, CE-BGH_12_Density_Saetze, fig.height = 6, fig.width = 9}
ggplot(data = dt.bgh.meta)+
...
```{r, CE-BGH_02_Barplot_Entscheidungstyp, fig.height = 6, fig.width = 9}
...
```{r, CE-BGH_03_Barplot_Spruchkoerper_AZ, fig.height = 6, fig.width = 9}
...
```{r, CE-BGH_05_Barplot_PraesidentIn, fig.height = 6, fig.width = 9}
...
```{r, CE-BGH_06_Barplot_VizePraesidentIn, fig.height = 6, fig.width = 9}
...
```{r, CE-BGH_07_Barplot_Entscheidungsjahr, fig.height = 6, fig.width = 9}
...
```{r, CE-BGH_08_Barplot_EingangsjahrISO, fig.height = 6, fig.width = 9}
